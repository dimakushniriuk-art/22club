...
- **Ultimo aggiornamento:** 2026-04-07 (`src/lib/analytics-chart-theme.ts`: palette unificata Recharts per `/dashboard/statistiche` — trainer + `trend-chart` / `distribution-chart` legacy)
