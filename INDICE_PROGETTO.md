...
|---------|--------------|------------|
| Clienti | `src/app/dashboard/clienti/page.tsx` | `src/hooks/use-clienti.ts`, `src/hooks/use-clienti-permissions.ts` |
| Appuntamenti / calendario | `dashboard/appuntamenti`, `dashboard/calendario`, `api/dashboard/appointments`, `api/calendar/*` | `src/lib/appointment-utils.ts`, `src/hooks/use-transformed-appointments.ts`, `src/lib/appointments/` |
...
| Abbonamenti | `dashboard/abbonamenti`, aree ruolo | `src/lib/abbonamenti-service-type.ts`, `src/lib/documents.ts` (fatture / preview) |
