...
console.log(
  '  psql "postgresql://postgres.icibqnmtacibgnhaidlz:[PASSWORD]@aws-0-eu-central-1.pooler.supabase.com:5432/postgres" -f supabase/migrations/20250117_fix_workout_logs_athlete_insert.sql',
)
console.log('')
