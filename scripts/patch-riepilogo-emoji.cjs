...
s = s.replace(
  /<div className="min-h-0 flex-1 overflow-auto px-3 pb-24 safe-area-inset-bottom sm:px-4 md:px-6 flex items-center justify-center">\s*<Card className="relative overflow-hidden border-red-500\/30 bg-background-secondary\/50 max-w-md w-full">\s*<CardContent[^>]+>\s*<div className="mb-3 text-4xl opacity-50">[^<]+<\/div>/m,
  `<div className="min-h-0 flex-1 overflow-auto px-3 pb-28 safe-area-inset-bottom sm:px-4 md:px-6 md:pb-24 flex items-center justify-center">
