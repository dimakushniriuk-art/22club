...
/**
 * Crea una nuova comunicazione (created_by_profile_id = profiles.id creatore)
 */
...
export async function getCommunications(options?: {
  ...
  try {
    ...
    if (options?.created_by_profile_id) {
      countQuery = countQuery.eq('created_by_profile_id', options.created_by_profile_id)
    }
    ...
    if (options?.created_by_profile_id) {
      query = query.eq('created_by_profile_id', options.created_by_profile_id)
    }
