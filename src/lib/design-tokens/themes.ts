...
export const roleThemes: Record<'athlete' | 'trainer' | 'admin', RoleTheme> = {
  athlete: {
    ...
    gradientPrimary: 'bg-gradient-to-br from-teal-900 to-cyan-900',
    gradientHover: 'hover:from-teal-800 hover:to-cyan-800',
    borderPrimary: 'border-teal-700/50',
  ...
  trainer: {
    ...
    gradientPrimary: 'bg-gradient-to-br from-blue-900 to-indigo-900',
    gradientHover: 'hover:from-blue-800 hover:to-indigo-800',
    borderPrimary: 'border-blue-700/50',
  ...
  admin: {
    ...
    gradientPrimary: 'bg-gradient-to-br from-gray-800 to-purple-900',
    gradientHover: 'hover:from-gray-700 hover:to-purple-800',
    ...
    buttonSecondary: 'border-purple-500 text-purple-400 hover:bg-purple-500/10 hover:border-purple-400',
