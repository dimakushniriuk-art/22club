...
export const roleThemes: Record<'athlete' | 'trainer' | 'admin', RoleTheme> = {
  athlete: {
    ...
    borderPrimary: 'border border-slate-600/40 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.04)] border-l-[3px] border-l-teal-500/80',
  ...
  trainer: {
    ...
    gradientPrimary: 'bg-slate-900/95',
    gradientHover: 'hover:bg-slate-800/95',
    borderPrimary: 'border border-slate-600/40 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.04)] border-l-[3px] border-l-indigo-500/80',
  ...
  admin: {
    ...
    gradientPrimary: 'bg-slate-900/95',
    gradientHover: 'hover:bg-slate-800/95',
    borderPrimary: 'border border-slate-600/40 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.04)] border-l-[3px] border-l-violet-500/70',
