...
export const AUTH_PAGE_WRAPPER_CLASS =
  'page-login min-h-full min-w-0 w-full flex-1 bg-background text-text-primary flex items-center justify-center px-4 py-4 md:px-6 md:py-6 safe-area-inset'

export const AUTH_CARD_CLASS =
  'w-full max-w-md md:max-w-lg overflow-hidden rounded-lg border border-white/10 bg-gradient-to-b from-zinc-900/95 to-black/80 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.04)] backdrop-blur-xl'

export const AUTH_CARD_CONTENT_CLASS = 'p-5 sm:p-6 md:p-8'
...
export const AUTH_LOGO_CLASS =
  'w-auto h-24 sm:h-28 md:h-32 object-contain drop-shadow-[0_0_24px_rgba(255,255,255,0.08)]'
