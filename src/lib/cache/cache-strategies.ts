...
export const frequentQueryCache = {
  ...
  /** Invalida tutte le chiavi il cui prefisso è queryKeyPrefix (es. "abbonamenti" per tutte le pagine). */
  invalidatePrefix: (queryKeyPrefix: string): void => {
    cacheManager.invalidatePattern(queryKeyPrefix, 'frequent-query')
  },
}
