...
import { type UnifiedDocumentItem } from '@/lib/all-athlete-documents'
import { useAthleteUnifiedDocuments } from '@/hooks/use-athlete-unified-documents'
import {
  Badge,
  Button,
  Card,
...
function DocumentiPageContent() {
  ...
  const performUpload = useCallback(
    ...
    [athleteProfileId, refetchDocuments, notify],
  )
...
export function HomeDocumentiPageContent() {
  return (
