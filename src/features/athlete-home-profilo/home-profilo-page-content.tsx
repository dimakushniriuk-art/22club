...
export function HomeProfiloPageContent() {
  ...
  const { data: anagrafica } = useAthleteAnagrafica(athleteUserId || null, {
    enabled: needAnagrafica,
  })
  const { data: administrative } = useAthleteAdministrative(athleteUserId || null, {
    enabled: needAdministrative,
  })
