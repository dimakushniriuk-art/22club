...
import { useNutrizionistaPlansList } from '@/hooks/use-nutrizionista-plans-list'
import {
  Button,
  Input,
  Label,
...
type VersionRow = NutrizionistaPlanVersionRow
...
export function NutrizionistaPlansPageContent() {
  ...
  }, [caricaPianoAthleteId, caricaPianoFile, profileId, orgId, supabase, reload])
  ...
  }, [unassignedRenameRow, unassignedRenameValue, supabase, reload])
  ...
  }, [unassignedAssignRow, unassignedAssignAthleteId, orgId, profileId, supabase, reload])
  ...
  }, [unassignedDeleteRow, supabase, reload])
  ...
  }, [validityEditRow, validityEditStart, validityEditEnd, supabase, reload, canEditValidity])
