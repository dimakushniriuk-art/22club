...
import { useMassaggiatoreClientiList } from '@/hooks/use-massaggiatore-clienti-list'
...
type UnifiedClienteRow = MassaggiatoreUnifiedClienteRow
type ProfileRow = MassaggiatoreClienteProfileRow
...
export function MassaggiatoreClientiPageContent() {
  ...
  }, [removeTarget, user?.id, supabase, notify, reload])
