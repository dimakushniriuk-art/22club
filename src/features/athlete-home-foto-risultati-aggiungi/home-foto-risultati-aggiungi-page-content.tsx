...
import {
  ...
  invalidateProgressPhotosQueries,
...
export function HomeFotoRisultatiAggiungiPageContent() {
  ...
  const handleSalvaLeFoto = useCallback(async () => {
    ...
    void invalidateProgressPhotosQueries(queryClient, profileId)
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col bg-background">
      <div className="min-h-0 flex-1 overflow-auto px-4 pb-24 safe-area-inset-bottom sm:px-5 sm:space-y-6 md:px-6 space-y-4">
        ...
        <p className="text-text-tertiary text-xs md:text-sm text-center px-2">
