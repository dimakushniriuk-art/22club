...
function StaffChatInteractive({ basePath = '/dashboard/chat' }: ChatPageContentProps) {
...
export function ChatPageContent({ basePath = '/dashboard/chat' }: ChatPageContentProps) {
  ...
  return <StaffChatInteractive basePath={basePath} />
}

export function StaffTrainerChatPageContent() {
