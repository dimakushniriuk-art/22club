...
function DeferredAthleteTabPanel({
  tab,
  activeTab,
  className,
  children,
}: {
  tab: AthleteProfileTab
...
export function NutrizionistaAthleteHubPageContent({
  params,
}: {
  ...
  return (
    ...
    >
      <Tabs value={resolvedTab} onValueChange={onAthleteTabChange} className="w-full">
        ...
        <DeferredAthleteTabPanel tab="overview" activeTab={resolvedTab} className="mt-4 space-y-4">
        ...
        </DeferredAthleteTabPanel>

        <DeferredAthleteTabPanel tab="piani" activeTab={resolvedTab} className="mt-4">
        ...
        <DeferredAthleteTabPanel tab="struttura" activeTab={resolvedTab} className="mt-4 space-y-4">
        ...
        <DeferredAthleteTabPanel tab="progressi" activeTab={resolvedTab} className="mt-4">
        ...
        <DeferredAthleteTabPanel tab="analisi" activeTab={resolvedTab} className="mt-4">
        ...
        <DeferredAthleteTabPanel tab="adattamenti" activeTab={resolvedTab} className="mt-4">
          <div className="rounded-xl border border-border overflow-hidden">
            <table className="w-full text-sm">
              <thead className="bg-background-tertiary/50 border-b border-border">
                <tr className="text-left text-text-secondary">
        ...
        <DeferredAthleteTabPanel tab="documenti" activeTab={resolvedTab} className="mt-4">
          <div className="rounded-xl border border-border bg-background-secondary/50 p-3 sm:p-4">
