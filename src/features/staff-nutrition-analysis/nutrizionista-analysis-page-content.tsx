...
import { useNutrizionistaWeeklyAnalysis } from '@/hooks/use-nutrizionista-weekly-analysis'
...
import type { NutrizionistaWeeklyAnalysisRow } from '@/lib/dashboard/fetch-nutrizionista-weekly-analysis'
import type { Json } from '@/types/supabase'

const logger = createLogger('app:dashboard:nutrizionista:analisi')
const THRESHOLD_KG = 0.3

type WeeklyRow = NutrizionistaWeeklyAnalysisRow
...
export function NutrizionistaAnalysisPageContent() {
