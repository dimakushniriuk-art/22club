...
import { useNutrizionistaAtletiList } from '@/hooks/use-nutrizionista-atleti-list'
...
import type { NutrizionistaAthleteListRow } from '@/lib/dashboard/fetch-nutrizionista-atleti-list'
const logger = createLogger('app:dashboard:nutrizionista:atleti')
const DEBOUNCE_MS = 300

type AthleteRow = NutrizionistaAthleteListRow
...
export function NutrizionistaAthletesPageContent() {
  ...
  useEffect(() => {
    if (!invitesWarning) return
    notify(invitesWarning, 'warning', 'Inviti')
  }, [invitesWarning, notify])
  ...
  const handlePause = useCallback(
    ...
    [profileId, supabase, reload, notify],
  )
  ...
  }, [removeConfirm, profileId, supabase, reload, notify])
  ...
  }, [progressModalAthlete, profileId, progressWeight, progressNotes, supabase, reload, notify])
