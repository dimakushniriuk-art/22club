...
import { useMarketingAthletes } from '@/hooks/use-marketing-athletes'
...
export function MarketingAthletesPageContent() {
  const { showLoader, canAccess } = useMarketingDashboardGuard()
  const { data, loading, error } = useMarketingAthletes(canAccess)
