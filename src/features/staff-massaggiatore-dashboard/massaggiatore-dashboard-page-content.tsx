...
import { isMassageAgendaEvent } from '@/lib/dashboard/staff-agenda-event-filters'
import { MassaggiatoreDashboardWidgetColumns } from './massaggiatore-dashboard-widget-columns'
...
export function MassaggiatoreDashboardPageContent() {
  ...
  const {
    ...
    error: statsError,
    reload: reloadStats,
  } = useMassaggiatoreDashboardStats(user?.id, deferSecondaryData)
