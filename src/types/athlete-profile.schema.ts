...
// Schema base per creazione (senza refinements per permettere .partial())
export const baseCreateAthleteAdministrativeDataSchema = athleteAdministrativeDataSchema
...
export const createAthleteAdministrativeDataSchema =
  baseCreateAthleteAdministrativeDataSchema.refine(
    (data) => {
...
export const updateAthleteAdministrativeDataSchema = baseCreateAthleteAdministrativeDataSchema
  .partial()
  .omit({ athlete_id: true })
  .refine(
    (data) => {
