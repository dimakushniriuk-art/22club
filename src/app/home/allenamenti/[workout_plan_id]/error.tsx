...
/**
 * Error boundary per route dinamiche workout plan
 * Isola errori in questa route senza buttare giù tutta l'app
 */
export default function WorkoutPlanError({ error, reset }: ErrorPageProps) {
  ...
  useEffect(() => {
    ...
    if (process.env.NODE_ENV === 'development') {
      console.error('WorkoutPlanError:', error)
    }
  }, [error])
      ...
      <Card className="w-full max-w-md border-red-500/40 bg-gradient-to-br from-red-500/10 via-transparent to-orange-500/5">
        <CardHeader className="text-center">
          ...
          <CardDescription className="text-gray-400">
            Si è verificato un errore durante il caricamento del piano di allenamento.
          </CardDescription>
        </CardHeader>
