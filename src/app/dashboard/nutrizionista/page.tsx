...
function isNutritionAgendaEvent(description: string | undefined): boolean {
  ...
  const loadStats = useCallback(async () => {
    ...
    try {
      ...
      if (supabaseErrors.length > 0) {
        ...
        setStatsError(msg)
        logger.error('Dashboard nutrizionista: errori query Supabase', {
          errors: supabaseErrors.map((e) => ({
            message: e?.message,
            code: e && 'code' in e ? (e as { code?: string }).code : undefined,
          })),
        })
      }
      ...
      logger.error('Errore caricamento dashboard nutrizionista', e)
