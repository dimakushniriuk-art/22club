...
export function SentryExamplePageContent() {
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined' && 'requestIdleCallback' in window) {
      ...
      timeoutId = globalThis.setTimeout(schedule, 0)
    }
      ...
      <main>
        ...
        <p className="description">
          ...
          <a
            target="_blank"
            rel="noopener"
            href="https://22club.sentry.io/issues/?project=4511098874560592"
          >
            Issues Page
          </a>
        ...
        <button
          ...
          disabled={!connectivityChecked || !isConnected}
        >
        ...
        ) : connectivityChecked && !isConnected ? (
