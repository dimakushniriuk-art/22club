...
const Input = React.forwardRef<HTMLInputElement, InputProps>(
  (
    ...
    const variants = {
      default:
        'border-border focus:border-input-focus focus:ring-2 focus:ring-primary/20 focus:outline-none',
      error: 'border-input-error focus:border-state-error focus:ring-2 focus:ring-state-error/20',
      success: 'border-state-valid focus:border-state-valid focus:ring-2 focus:ring-state-valid/20',
      warning: 'border-state-warn focus:border-state-warn focus:ring-2 focus:ring-state-warn/20',
    }
