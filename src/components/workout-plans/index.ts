/**
 * @fileoverview Export centralizzato per componenti workout plans
 * @module components/workout-plans
 */
...
export { WorkoutPlansEmptyState } from './workout-plans-empty-state'
