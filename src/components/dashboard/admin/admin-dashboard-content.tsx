    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Link href="/dashboard/admin/utenti/marketing">
          <Button
            variant="outline"
            className="w-full h-auto flex flex-col items-center justify-center gap-2 p-6 bg-gradient-to-br from-cyan-500/10 to-blue-500/10 border-cyan-500/30 hover:bg-gradient-to-br hover:from-cyan-500/20 hover:to-blue-500/20 hover:border-cyan-500/50 transition-all duration-200 hover:scale-105"
          >
            <BarChart3 className="h-6 w-6 text-cyan-400" />
            <span className="text-sm font-medium text-white">Crea utente Marketing</span>
          </Button>
        </Link>
      </div>
    </div>
