...
*(Larghezza e altezza sono in CSS logical pixels, viewport. Il DPR non si imposta nel layout; serve per scaling e asset.)*
...
*(Dettaglio implementativo: Tailwind, `globals.css`, eventuali variabili CSS e progetti Playwright per test su queste dimensioni.)*
